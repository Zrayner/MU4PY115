...
mc_iterations = 50
acceptation = []
mc_positions = all_positions[:mc_time,:,:] / delta
mc_energies = all_energies[1:mc_time+1]
...
for i_time in range(1,_mc_time):
    ...
    while t < mc_iterations:
        ...
        diff_E = (guess_energy_overtime[i_time-1] - try_energy)*1.6e-22
        if diff_E < 0 : 
            accepted_try_energies[t] = try_energy
    ...
    guess_energy_overtime[i_time]=accepted_try_energies[np.argmin(accepted_try_energies)]
