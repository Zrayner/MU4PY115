...
print("max error=",max(np.absolute(descaled_energies[data_params['val_limit']:]-descaled_predicted_energies)))
...
plt.plot(descaled_energies[data_params['val_limit']:],descaled_predicted_energies,'.',markersize=2)
