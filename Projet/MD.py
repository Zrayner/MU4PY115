...
energies_train = energies_train[:,np.newaxis].tolist()
energies_test=energies[8000:]
energies_test = energies_test[:,np.newaxis].tolist()
...
history=model_TOT.fit(descriptors_train, energies_train,
