...
model_H=create_hydrogen_model()
model_O=create_oxygen_model()
...
def compile_model(model,optimizer=keras.optimizers.Adam()):
    # create the mode
    # compile the model
